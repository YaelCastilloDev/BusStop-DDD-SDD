...
1. Set `BusStop.AspireHost` as the startup project
...
When running through Aspire, the connection string is automatically provided by Aspire and will override the `DefaultConnection` in appsettings.json. The connection is named "busstop" and is referenced in the Web project.
