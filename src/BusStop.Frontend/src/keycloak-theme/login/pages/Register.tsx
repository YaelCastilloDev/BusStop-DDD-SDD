  ...
  return (
    ...
    >
      {messageHeader !== undefined ? (
        <p className='text-body-sm text-center text-primary font-medium'>
      ...
      <div className='flex items-center justify-center gap-2'>
        ...
        <p className='text-base text-foreground font-medium'>
          {(() => {
            const text = msgStr('orSignUpWith')
            return text !== 'orSignUpWith' ? text : 'or sign up with'
          })()}
        </p>
        <hr className='grow border' />
      </div>
      ...
      >
        <div className='mb-4'>
          <div className='mb-2 block'>
            <Label htmlFor='firstName' className='font-semibold'>{msgStr('firstName')}</Label>
          </div>
          <Input
            id='firstName'
            name='firstName'
        ...
        <div className='mb-4'>
          <div className='mb-2 block'>
            <Label htmlFor='lastName' className='font-semibold'>{msgStr('lastName')}</Label>
          </div>
          <Input
            id='lastName'
            name='lastName'
        ...
        <div className='mb-4'>
          <div className='mb-2 block'>
            <Label htmlFor='email' className='font-semibold'>{msgStr('email')}</Label>
          </div>
          <Input
            id='email'
            name='email'
        ...
        <div className='mb-4'>
          <div className='mb-2 block'>
            <Label htmlFor='username' className='font-semibold'>{msgStr('username')}</Label>
          </div>
          <Input
            id='username'
            name='username'
        ...
        <div className='mb-6'>
          <div className='mb-2 block'>
            <Label htmlFor='password-confirm' className='font-semibold'>
